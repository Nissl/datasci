...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    hr_year_team = pandas.read_csv(hr_by_team_year_sf_la_csv)
    print (ggplot(hr_year_team, aes('yearID', 'HR', color = 'teamID')) + 
...
input_file = "%s/hr_by_team_year_sf_la.csv" % local_dir
print(lineplot_compare(input_file))