...
def aggregate_query(filename):
    ...
    q = "SELECT district, gender, SUM(aadhaar_generated) FROM aadhaar_data WHERE age > 50 GROUP BY district, gender;"
...
input_file = "%s/UIDAI-ENR-DETAIL-20140219.csv" % local_dir
print(aggregate_query(input_file))