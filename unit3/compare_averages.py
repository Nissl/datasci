...
def compare_averages(filename):
    ...
    stats = scipy.stats.ttest_ind(baseball_data_left["avg"], 
                          baseball_data_right["avg"], 
                          equal_var=False)
    if stats[1] <= .05:
        result = False
    else:
...
local_dir = "/Users/johnmorgan/datasci/unit3"
input_file = "%s/baseball_data.csv" % local_dir
print(compare_averages(input_file))

# Official sol'n notes:
